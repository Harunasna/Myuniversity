...
{
  if(isset($_SESSION["signup_data"]["jambReg"])) {

    // thowback the valid user input['username'];
   echo '<input type="text" name="jambReg" maxlength="16" value="' . $_SESSION["signup_data"]["jambReg"] . '">';
} else {
  // echo a new form to fill
  echo '<input type="text" name="jambReg" max="16">';
}     
}
// for uni-choice throw back;
function signup_input_uniChoice() 
{
  if(isset($_SESSION["signup_data"]["uniChoice"])) {

    // thowback the valid user input['username']
   echo '<select name="uniChoice" id="uni-choice">
              <option>'. $_SESSION["signup_data"]["uniChoice"].'</option>
...
{
  if(isset($_SESSION["signup_data"]["jambScore"])) {

    // thowback the valid user input['username']
   echo '<input type="text" name="jambScore" maxlength="3" value="' . $_SESSION["signup_data"]["jambScore"] . '">';
  } else{
  echo '<input type="text" name="jambScore" maxlength="3">';
}       
}
